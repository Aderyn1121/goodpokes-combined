        ...
        if (!this.state.byType) {
            return (
                <div>
                    ...
                    <h1 className='ui inverted segment' style={{ fontSize: '20px', textDecoration: 'bold', padding: '10px 0', textAlign: 'center' }}>All</h1>
            ...
            return (
                <div>
                    ...
                    <h1 className='ui inverted segment' style={{ fontSize: '20px', textDecoration: 'bold', padding: '10px 0', textAlign: 'center' }}>{this.state.type}</h1>
